...
public class GameLauncher {
    ...
    public static void main(String[] args) throws Exception {
        ...
        VDFNode apps = v.getRoot().get("UserLocalConfigStore").get("Software").get("Valve").get("Steam").get("apps");
        int game = 440;
...
//        }
        ...
        for (int i = 0; i < l.getChildCount(); i++) {
            ...
            System.out.println("[" + oslist + "] " + new File(dir.getPath(), executable).getPath() + " " + arguments);
        }
    }
}
